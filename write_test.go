...
func TestWriteTree(t *testing.T) {
	for n, test := range [...]struct {
		...
		},
		{
			...
			Output: []byte{'1', '2', '3', 0, 3, 2, 6, 0, 'C', 'h', 'i', 'l', 'd', '1', 6, 0, 0, 0, 0, 0, 0, 0, 16, 0, 2},
		},
		{
			Input: node{
				children: []node{
			...
			Output: []byte{'1', '2', '3', 0, 3, 2, 'q', 'w', 'e', 'r', 't', 'y', 0, 6, 2, 6, 7, 0, 'C', 'h', 'i', 'l', 'd', '1', 'c', 'h', 'i', 'l', 'd', '-', '2', 6, 0, 0, 0, 0, 0, 0, 0, 15, 0, 0, 0, 0, 0, 0, 0, 32, 0, 2},
		},
		{
			Input: node{
				children: []node{
			...
			Output: []byte{'q', 'w', 'e', 'r', 't', 'y', 0, 6, 2, '1', '2', '3', 0, 3, 2, 6, 7, 0, 'C', 'h', 'i', 'l', 'd', '1', 'c', 'h', 'i', 'l', 'd', '-', '2', 15, 0, 0, 0, 0, 0, 0, 0, 9, 0, 0, 0, 0, 0, 0, 0, 'a', 'b', 'c', 32, 3, 2},
		},
	} {
